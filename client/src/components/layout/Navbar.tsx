...
import LogoImg from "../../assets/foodcommerce.png";
...
<div className="hidden md:flex items-center gap-8 text-gray-800 text-sm relative">
 ...
 text-white text-xs w-5 h-5 flex items-center justify-center rounded-full">
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 flex flex-col gap-4 px-6 py-4 text-gray-800 text-sm">
          <input
            type="text"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            placeholder="Search products..."
            className="w-full px-3 py-1.5 text-sm border border-gray-200 rounded-md focus:outline-none focus:border-gray-400"
